...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/micsu/fuerte_workspace/fsr2013/fuerte-unstable-devel/pcl17/build/pcl_trunk")
...
set(pcl_all_components  common kdtree octree search sample_consensus filters io 2d features geometry visualization ml segmentation people surface registration keypoints stereo recognition tracking )
...
list (APPEND PCL_DEFINITIONS " -march=native -msse4.1 -mfpmath=sse")
endif()
