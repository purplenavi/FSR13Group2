...
class ObjectRecognition
{
    ...
    populateDatabase (const std::vector<std::string> & filenames)
    {
      ...
      for (size_t i = 0; i < n; ++i)
      {
        ...
        if (filename.compare (filename.size ()-4, 4, ".pcd") == 0)
        {
          ...
          pcl17::io::loadPCDFile (filenames[i], *raw_input);
      ...
      kdtree_ = pcl17::KdTreeFLANN<GlobalDescriptorT>::Ptr (new pcl17::KdTreeFLANN<GlobalDescriptorT>);
  ...
  protected: 
    ...
    applyFiltersAndSegment (const PointCloudPtr & input, const ObjectRecognitionParameters & params) const
    {
      ...
      pcl17::copyPointCloud (*cloud, cluster_indices[0], *largest_cluster);
                      ...
                      const ObjectRecognitionParameters & params) const
    {
      ...
      pcl17::transformPointCloud (*(source.points), *output, tform);
    ...
    pcl17::KdTreeFLANN<GlobalDescriptorT>::Ptr kdtree_;
};
