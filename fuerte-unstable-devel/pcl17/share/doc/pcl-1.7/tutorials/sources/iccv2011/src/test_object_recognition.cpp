...
//./test_object_recognition /home/aitor/PCL17_tutorial_iros/data/minnie/raw_4.pcd --objects_root_path /home/aitor/PCL17_tutorial_iros/data --objects ../../data/objects.txt --filter ../../params/filter.txt --segment ../../params/segment.txt --feature ../../params/feature.txt --registration ../../params/registration.txt
...
main (int argc, char ** argv)
{
  if (argc < 3) 
  {
    pcl17::console::print_info ("Syntax is: %s query.pcd <options>\n", argv[0]);
    pcl17::console::print_info ("  where options are:\n");
    pcl17::console::print_info ("    --objects_root_path root_path ......... Root path to append to files in object_files.txt \n");
    pcl17::console::print_info ("    --objects object_files.txt ......... A list of the files to use as exemplars\n");
  ...
  pcl17::io::loadPCDFile (argv[1], *query);
  ...
  pcl17::console::parse_argument (argc, argv, "--objects_root_path", objects_root_path);

  std::string objects_file;
  pcl17::console::parse_argument (argc, argv, "--objects", objects_file);
  ...
  pcl17::visualization::PointCloudColorHandlerCustom<PointT> red (aligned_model_points, 255, 0, 0);
  vis.addPointCloud (aligned_model_points, red, "model");
  vis.setPointCloudRenderingProperties (pcl17::visualization::PCL17_VISUALIZER_POINT_SIZE, 2, "model");
  vis.resetCamera ();
