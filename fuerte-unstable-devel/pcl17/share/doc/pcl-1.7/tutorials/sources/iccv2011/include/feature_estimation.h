...
estimateSurfaceNormals (const PointCloudPtr & input, float radius)
{
  ...
  normal_estimation.setSearchMethod (pcl17::search::Search<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
                 ...
                 float min_scale, int nr_octaves, int nr_scales_per_octave, float min_contrast)
{
  ...
  sift_detect.setSearchMethod (pcl17::search::Search<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
                         ...
                         const PointCloudPtr & keypoints, float feature_radius)
{
  ...
  fpfh_estimation.setSearchMethod (pcl17::search::Search<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
...
computeGlobalDescriptor (const PointCloudPtr & points, const SurfaceNormalsPtr & normals)
{
  ...
  vfh_estimation.setSearchMethod (pcl17::search::Search<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
