...
{
  pcl17::SampleConsensusInitialAlignment<PointT, PointT, LocalDescriptorT> sac_ia;
                 ...
                 float outlier_rejection_threshold, float transformation_epsilon, float max_iterations)
{
  ...
  pcl17::IterativeClosestPoint<PointT, PointT> icp;
  ...
  pcl17::transformPointCloud (*source_points, *source_points_transformed, initial_alignment);
