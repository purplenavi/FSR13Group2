                              ...
                              std::vector<int> & correspondences_out, std::vector<float> & correspondence_scores_out)
{
  ...
  pcl17::KdTreeFLANN<LocalDescriptorT> descriptor_kdtree;
...
{ 
  ...
  pcl17::transformPointCloud (*points1, *points_left, -translate, no_rotation);
  pcl17::transformPointCloud (*keypoints1, *keypoints_left, -translate, no_rotation);

  // Shift the second clouds' points to the right
  pcl17::transformPointCloud (*points2, *points_right, translate, no_rotation);
  pcl17::transformPointCloud (*keypoints2, *keypoints_right, translate, no_rotation);
...
main (int argc, char ** argv)
{
  if (argc < 3) 
  {
    ...
    pcl17::console::print_info ("    -n nr_correspondences ... The number of correspondence to draw (Default = all)\n");
  ...
  pcl17::console::parse_argument (argc, argv, "-n", nr_correspondences);
