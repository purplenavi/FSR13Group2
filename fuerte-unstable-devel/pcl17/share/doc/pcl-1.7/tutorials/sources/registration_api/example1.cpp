...
#include <pcl17/registration/correspondence_estimation_normal_shooting.h>
#include <pcl17/registration/correspondence_estimation_backprojection.h>
#include <pcl17/registration/correspondence_rejection_median_distance.h>
#include <pcl17/registration/correspondence_rejection_surface_normal.h>
#include <pcl17/registration/transformation_estimation_point_to_plane_lls.h>
#include <pcl17/registration/default_convergence_criteria.h>
...
using namespace pcl17::io;
using namespace pcl17::console;
using namespace pcl17::registration;
                          ...
                          Correspondences &remaining_correspondences)
{
  ...
  PCL17_DEBUG ("[rejectBadCorrespondences] Number of correspondences remaining after rejection: %d\n", remaining_correspondences_temp->size ());
...
view (const CloudConstPtr &src, const CloudConstPtr &tgt, const CorrespondencesPtr &correspondences)
{
  ...
  vis->setPointCloudRenderingProperties (PCL17_VISUALIZER_OPACITY, 0.5, "source");
  vis->setPointCloudRenderingProperties (PCL17_VISUALIZER_OPACITY, 0.7, "target");
  vis->setPointCloudRenderingProperties (PCL17_VISUALIZER_POINT_SIZE, 6, "source");
  TicToc tt;
  tt.tic ();
  ...
  tt.toc_print ();
  vis->setShapeRenderingProperties (PCL17_VISUALIZER_LINE_WIDTH, 5, "correspondences");
  //vis->setShapeRenderingProperties (PCL17_VISUALIZER_COLOR, 1.0, 0.0, 0.0, "correspondences");
  vis->spin ();
}
