...
#include <pcl17/surface/marching_cubes_greedy.h>
...
{
  pcl17::MovingLeastSquares<PointT, NormalT> mls;
  mls.setSearchMethod (pcl17::KdTreeFLANN<PointT>::Ptr (new pcl17::KdTreeFLANN<PointT>));
...
computeSurfaceElements (const PointCloudPtr & input, float radius, int polynomial_order)
{
  ...
  pcl17::copyPointCloud (*points, *surfels);
  pcl17::copyPointCloud (*normals, *surfels);
  return (surfels);
}
...
{
  pcl17::ConvexHull<PointT> convex_hull;
...
{
  pcl17::ConcaveHull<PointT> concave_hull;
...
{
  pcl17::GreedyProjectionTriangulation<pcl17::PointNormal> gpt;
  gpt.setSearchMethod (pcl17::KdTreeFLANN<pcl17::PointNormal>::Ptr (new pcl17::KdTreeFLANN<pcl17::PointNormal>));
...
{
  pcl17::MarchingCubesGreedy<SurfelT> marching_cubes;
  marching_cubes.setSearchMethod (pcl17::KdTree<SurfelT>::Ptr (new pcl17::KdTreeFLANN<SurfelT> ()));
