...
{
  pcl17::NormalEstimation<PointT, NormalT> normal_estimation;
  normal_estimation.setSearchMethod (pcl17::search::KdTree<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
...
{
  pcl17::SIFTKeypoint<PointT, pcl17::PointWithScale> sift_detect;
  sift_detect.setSearchMethod (pcl17::search::KdTree<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
  sift_detect.setScales (min_scale, nr_octaves, nr_scales_per_octave);
  sift_detect.setMinimumContrast (min_contrast);
  sift_detect.setInputCloud (points);
  pcl17::PointCloud<pcl17::PointWithScale> keypoints_temp;
  sift_detect.compute (keypoints_temp);
  PointCloudPtr keypoints (new PointCloud);
  pcl17::copyPointCloud (keypoints_temp, *keypoints);
...
{
  pcl17::FPFHEstimation<PointT, NormalT, LocalDescriptorT> fpfh_estimation;
  fpfh_estimation.setSearchMethod (pcl17::search::KdTree<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
...
{
  pcl17::VFHEstimation<PointT, NormalT, GlobalDescriptorT> vfh_estimation;
  vfh_estimation.setSearchMethod (pcl17::search::KdTree<PointT>::Ptr (new pcl17::search::KdTree<PointT>));
