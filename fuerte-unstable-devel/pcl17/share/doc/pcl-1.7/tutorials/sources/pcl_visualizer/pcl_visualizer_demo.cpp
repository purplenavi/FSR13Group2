...
boost::shared_ptr<pcl17::visualization::PCLVisualizer> simpleVis (pcl17::PointCloud<pcl17::PointXYZ>::ConstPtr cloud)
{
  // --------------------------------------------
...
boost::shared_ptr<pcl17::visualization::PCLVisualizer> customColourVis (pcl17::PointCloud<pcl17::PointXYZ>::ConstPtr cloud)
{
  // --------------------------------------------
  // -----Open 3D viewer and add point cloud-----
  // --------------------------------------------
  boost::shared_ptr<pcl17::visualization::PCLVisualizer> viewer (new pcl17::visualization::PCLVisualizer ("3D Viewer"));
  viewer->setBackgroundColor (0, 0, 0);
  pcl17::visualization::PointCloudColorHandlerCustom<pcl17::PointXYZ> single_color(cloud, 0, 255, 0);
  viewer->addPointCloud<pcl17::PointXYZ> (cloud, single_color, "sample cloud");
  viewer->setPointCloudRenderingProperties (pcl17::visualization::PCL17_VISUALIZER_POINT_SIZE, 3, "sample cloud");
  viewer->addCoordinateSystem (1.0);
  viewer->initCameraParameters ();
  return (viewer);
...
boost::shared_ptr<pcl17::visualization::PCLVisualizer> normalsVis (
    pcl17::PointCloud<pcl17::PointXYZRGB>::ConstPtr cloud, pcl17::PointCloud<pcl17::Normal>::ConstPtr normals)
{
  // --------------------------------------------------------
...
boost::shared_ptr<pcl17::visualization::PCLVisualizer> shapesVis (pcl17::PointCloud<pcl17::PointXYZRGB>::ConstPtr cloud)
{
  ...
  //------------------------------------
  viewer->addLine<pcl17::PointXYZRGB> (cloud->points[0],
...
boost::shared_ptr<pcl17::visualization::PCLVisualizer> viewportsVis (
    pcl17::PointCloud<pcl17::PointXYZRGB>::ConstPtr cloud, pcl17::PointCloud<pcl17::Normal>::ConstPtr normals1, pcl17::PointCloud<pcl17::Normal>::ConstPtr normals2)
{
  // --------------------------------------------------------
  // -----Open 3D viewer and add point cloud and normals-----
  // --------------------------------------------------------
...
void keyboardEventOccurred (const pcl17::visualization::KeyboardEvent &event,
                            void* viewer_void)
{
  boost::shared_ptr<pcl17::visualization::PCLVisualizer> viewer = *static_cast<boost::shared_ptr<pcl17::visualization::PCLVisualizer> *> (viewer_void);
...
void mouseEventOccurred (const pcl17::visualization::MouseEvent &event,
                         void* viewer_void)
{
  boost::shared_ptr<pcl17::visualization::PCLVisualizer> viewer = *static_cast<boost::shared_ptr<pcl17::visualization::PCLVisualizer> *> (viewer_void);
...
main (int argc, char** argv)
{
  ...
  // ------------------------------------
  pcl17::PointCloud<pcl17::PointXYZ>::Ptr basic_cloud_ptr (new pcl17::PointCloud<pcl17::PointXYZ>);
  ...
  for (float z(-1.0); z <= 1.0; z += 0.05)
  {
    ...
    {
      pcl17::PointXYZ basic_point;
      basic_point.x = 0.5 * cosf (pcl17::deg2rad(angle));
      basic_point.y = sinf (pcl17::deg2rad(angle));
      basic_point.z = z;
