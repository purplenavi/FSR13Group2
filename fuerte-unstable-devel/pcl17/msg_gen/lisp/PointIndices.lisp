...
(cl:defmethod cl:initialize-instance :after ((m <PointIndices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointIndices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl17-msg:<PointIndices> is deprecated: use pcl17-msg:PointIndices instead.")))
...
(cl:defmethod indices-val ((m <PointIndices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:indices-val is deprecated.  Use pcl17-msg:indices instead.")
  (indices m))
