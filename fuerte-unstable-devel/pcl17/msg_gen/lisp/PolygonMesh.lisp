...
(cl:defclass <PolygonMesh> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (polygons
    :reader polygons
    :initarg :polygons
    :type (cl:vector pcl17-msg:Vertices)
   :initform (cl:make-array 0 :element-type 'pcl17-msg:Vertices :initial-element (cl:make-instance 'pcl17-msg:Vertices))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PolygonMesh>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonMesh)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl17-msg:<PolygonMesh> is deprecated: use pcl17-msg:PolygonMesh instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:header-val is deprecated.  Use pcl17-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:cloud-val is deprecated.  Use pcl17-msg:cloud instead.")
  (cloud m))

(cl:ensure-generic-function 'polygons-val :lambda-list '(m))
(cl:defmethod polygons-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:polygons-val is deprecated.  Use pcl17-msg:polygons instead.")
  (polygons m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolygonMesh>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'polygons)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pcl17-msg:Vertices))
