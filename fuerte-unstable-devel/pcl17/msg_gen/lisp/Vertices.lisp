...
(cl:defmethod cl:initialize-instance :after ((m <Vertices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vertices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl17-msg:<Vertices> is deprecated: use pcl17-msg:Vertices instead.")))

(cl:ensure-generic-function 'vertices-val :lambda-list '(m))
(cl:defmethod vertices-val ((m <Vertices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:vertices-val is deprecated.  Use pcl17-msg:vertices instead.")
  (vertices m))
