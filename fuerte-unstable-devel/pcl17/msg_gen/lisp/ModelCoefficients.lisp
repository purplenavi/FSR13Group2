...
(cl:defmethod cl:initialize-instance :after ((m <ModelCoefficients>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ModelCoefficients)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl17-msg:<ModelCoefficients> is deprecated: use pcl17-msg:ModelCoefficients instead.")))
...
(cl:defmethod values-val ((m <ModelCoefficients>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl17-msg:values-val is deprecated.  Use pcl17-msg:values instead.")
  (values m))
