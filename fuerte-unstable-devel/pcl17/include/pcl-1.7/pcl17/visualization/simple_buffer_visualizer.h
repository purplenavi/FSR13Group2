#ifndef PCL17_VISUALIZATION_SIMPLE_BUFF_H
#define PCL17_VISUALIZATION_SIMPLE_BUFF_H

#include <pcl17/visualization/histogram_visualizer.h>

//#include <pcl17/visualization/impl/simple_buffer_visualizer.hpp>
...
namespace pcl17
{
  namespace visualization
  {
    /** \brief PCL simple buffer visualizer main class. 
      ...
      * \note The class is based on PCLHistogramVisualizer and pcl17::VFHSignature308 for display.
      * \note Therefore, the number of values is limited to [2-308].
      * \author Raphael Favier
      * \ingroup visualization
      */
    class PCL17_EXPORTS PCLSimpleBufferVisualizer
    {
      public:
        ...
        PCLSimpleBufferVisualizer (const int nb_values)
        {
          ...
          if(nb_values_ > 308)
          {
            PCL17_WARN("Maximum number of values can only be 308 (%d given). Setting back to 308. \n");
            nb_values_ = 308;
          }

          if(nb_values_ <= 1)
          {
            PCL17_WARN("Number of values must be at least 2 (%d given). Setting it to default (308). \n");
            nb_values_ = 308;     
          }
      ...
      private:
        ...
        initValuesAndVisualization ()
        {
          ...
          PCL17_WARN("Setting buffer size to %d entries.\n", nb_values_);
...
#endif // PCL17_VISUALIZATION_SIMPLE_BUFF_H
