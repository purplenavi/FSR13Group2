...
namespace pcl17
{
  ...
  template<typename PointT, int nbins_>
    class PCL17_EXPORTS CRHAlignment
    {
    private:
      ...
      typedef typename pcl17::PointCloud<PointT>::Ptr PointTPtr;
    ...
    public:
       ...
       */
      void
      align (pcl17::PointCloud<pcl17::Histogram<nbins_> > & input_ftt, pcl17::PointCloud<pcl17::Histogram<nbins_> > & target_ftt)
      {
       ...
       */
      void
      computeRollAngle (pcl17::PointCloud<pcl17::Histogram<nbins_> > & input_ftt, pcl17::PointCloud<pcl17::Histogram<nbins_> > & target_ftt,
                        std::vector<float> & peaks)
      {

        pcl17::PointCloud<pcl17::Histogram<nbins_> > input_ftt_negate (input_ftt);
