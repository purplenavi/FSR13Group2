...
#include <pcl17/recognition/hv/hypotheses_verification.h>
#include <pcl17/common/common.h>
#include "pcl17/recognition/3rdparty/metslib/mets.hh"
...
namespace pcl17
{
  ...
  class PCL17_EXPORTS GlobalHypothesesVerification: public HypothesisVerification<ModelT, SceneT>
  {
    private:
      ...
      struct RecognitionModel
      {
        public:
          ...
          typename pcl17::PointCloud<ModelT>::Ptr cloud_;
          typename pcl17::PointCloud<ModelT>::Ptr complete_cloud_;
      ...
      //class attributes
      typedef typename pcl17::NormalEstimation<SceneT, pcl17::Normal> NormalEstimator_;
      pcl17::PointCloud<pcl17::Normal>::Ptr scene_normals_;
      pcl17::PointCloud<pcl17::PointXYZI>::Ptr clusters_cloud_;
      ...
      bool
      addModel(typename pcl17::PointCloud<ModelT>::ConstPtr & model, typename pcl17::PointCloud<ModelT>::ConstPtr & complete_model,
...
#include <pcl17/recognition/impl/hv/hv_go.hpp>
#endif
