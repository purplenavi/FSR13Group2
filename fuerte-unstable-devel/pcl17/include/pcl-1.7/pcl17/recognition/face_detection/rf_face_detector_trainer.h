...
#ifndef PCL17_RF_FACE_DETECTOR_TRAINER_H_
#define PCL17_RF_FACE_DETECTOR_TRAINER_H_

#include "pcl17/recognition/face_detection/face_detector_data_provider.h"
#include "pcl17/recognition/face_detection/rf_face_utils.h"
#include "pcl17/ml/dt/decision_forest.h"
#include <pcl17/features/integral_image2D.h>

namespace pcl17
{
  class PCL17_EXPORTS RFFaceDetectorTrainer
  {
    private:
      int w_size_;
      int max_patch_size_;
      ...
      pcl17::PointCloud<pcl17::PointXYZ>::Ptr input_;
      pcl17::PointCloud<pcl17::PointXYZI>::Ptr face_heat_map_;

      typedef face_detection::RFTreeNode<face_detection::FeatureType> NodeType;
      pcl17::DecisionForest<NodeType> forest_;

      std::string model_path_;
      bool pose_refinement_;
      int icp_iterations_;

      pcl17::PointCloud<pcl17::PointXYZ>::Ptr model_original_;
      float res_;
    ...
    public:
      ...
      void setForest(pcl17::DecisionForest<NodeType> & forest)
      {
        forest_ = forest;
      }
      ...
      void getFaceHeatMap(pcl17::PointCloud<pcl17::PointXYZI>::Ptr & heat_map)
      {
        heat_map = face_heat_map_;
      }

      //get votes
      void getVotes(pcl17::PointCloud<pcl17::PointXYZ>::Ptr & votes_cloud)
      {
      ...
      void getVotes(pcl17::PointCloud<pcl17::PointXYZI>::Ptr & votes_cloud)
      {
        votes_cloud->points.resize (head_center_votes_.size ());
        votes_cloud->width = static_cast<int>(head_center_votes_.size ());
        votes_cloud->height = 1;
      ...
      void getVotes2(pcl17::PointCloud<pcl17::PointXYZI>::Ptr & votes_cloud)
      {
        votes_cloud->points.resize (head_center_votes_.size ());
        votes_cloud->width = static_cast<int>(head_center_votes_.size ());
        votes_cloud->height = 1;
       ...
       * Other functions
       */
      void setInputCloud(pcl17::PointCloud<pcl17::PointXYZ>::Ptr & cloud)
      {
        input_ = cloud;
      }

      void setFaceHeatMapCloud(pcl17::PointCloud<pcl17::PointXYZI>::Ptr & heat_map)
      {
...
#endif /* PCL17_RF_FACE_DETECTOR_TRAINER_H_ */
