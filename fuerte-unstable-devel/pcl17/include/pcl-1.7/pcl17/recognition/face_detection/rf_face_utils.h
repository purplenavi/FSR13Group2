...
#ifndef PCL17_RF_FACE_UTILS_H_
#define PCL17_RF_FACE_UTILS_H_

#include "pcl17/recognition/face_detection/face_common.h"
#include <pcl17/ml/feature_handler.h>
#include <pcl17/ml/stats_estimator.h>
#include <pcl17/ml/branch_estimator.h>
...
namespace pcl17
{
  namespace face_detection
  {
    ...
    class FeatureHandlerDepthAverage: public pcl17::FeatureHandler<FT, DataSet, ExampleIndex>
    {
      ...
      public:
        ...
        void evaluateFeature(const FT & feature, DataSet & data_set, const ExampleIndex & example, float & result, unsigned char & flag) const
        {
          ...
          {
            result = static_cast<float> (pcl17_round (static_cast<float>(rand ()) / static_cast<float> (RAND_MAX)));
            flag = 1;
          } else
          {
    ...
    class PoseClassRegressionVarianceStatsEstimator: public pcl17::StatsEstimator<LabelDataType, NodeType, DataSet, ExampleIndex>
    {
      ...
      private:
        ...
        pcl17::BranchEstimator * branch_estimator_;
    };
  }
}

#endif /* PCL17_RF_FACE_UTILS_H_ */
