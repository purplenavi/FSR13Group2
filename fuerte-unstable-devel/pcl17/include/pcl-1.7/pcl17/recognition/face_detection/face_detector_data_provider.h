...
namespace pcl17
{
  namespace face_detection
  {
    ...
    class FaceDetectorDataProvider: public pcl17::DecisionTreeTrainerDataProvider<FeatureType, DataSet, LabelType, ExampleIndex, NodeType>
    {
      private:
        int num_images_;
        ...
        void cropCloud(int min_col, int max_col, int min_row, int max_row, pcl17::PointCloud<PointInT> & cloud_in, pcl17::PointCloud<PointInT> & cloud_out)
        {
