#ifndef PCL17_TRACKING_COHERENCE_H_
#define PCL17_TRACKING_COHERENCE_H_
...
namespace pcl17
{
  ...
  namespace tracking
  {
    ...
    public:
      ...
      /** \brief get a list of pcl17::tracking::PointCoherence.*/
      inline std::vector<PointCoherencePtr>
      getPointCoherences () { return point_coherences_; }

      /** \brief set a list of pcl17::tracking::PointCoherence.
        * \param coherences a list of pcl17::tracking::PointCoherence.
        */
      inline void
...
#include <pcl17/tracking/impl/coherence.hpp>
