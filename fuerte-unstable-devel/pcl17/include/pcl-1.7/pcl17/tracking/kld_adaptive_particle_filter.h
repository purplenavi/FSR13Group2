#ifndef PCL17_TRACKING_KLD_ADAPTIVE_PARTICLE_FILTER_H_
#define PCL17_TRACKING_KLD_ADAPTIVE_PARTICLE_FILTER_H_
...
#include <pcl17/tracking/impl/kld_adaptive_particle_filter.hpp>
#endif
