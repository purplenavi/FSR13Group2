#ifndef PCL17_TRACKING_IMPL_TRACKING_H_
#define PCL17_TRACKING_IMPL_TRACKING_H_
...
namespace pcl17
{
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYZRPY : public _ParticleXYZRPY
    {
      ...
      static pcl17::tracking::ParticleXYZRPY
      toState (const Eigen::Affine3f &trans)
      {
        ...
        return pcl17::tracking::ParticleXYZRPY (trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw);
      }
    ...
    // a * k
    inline pcl17::tracking::ParticleXYZRPY operator * (const ParticleXYZRPY& p, double val)
    {
      pcl17::tracking::ParticleXYZRPY newp;
    ...
    // a + b
    inline pcl17::tracking::ParticleXYZRPY operator + (const ParticleXYZRPY& a, const ParticleXYZRPY& b)
    {
      pcl17::tracking::ParticleXYZRPY newp;
      newp.x = a.x + b.x;
      newp.y = a.y + b.y;
...
namespace pcl17
{
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYZR : public _ParticleXYZR
    {
      ...
      static pcl17::tracking::ParticleXYZR
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl17::tracking::ParticleXYZR (trans_x, trans_y, trans_z, 0, trans_pitch, 0));
      }
    ...
    // a * k
    inline pcl17::tracking::ParticleXYZR operator * (const ParticleXYZR& p, double val)
    {
      pcl17::tracking::ParticleXYZR newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl17::tracking::ParticleXYZR operator + (const ParticleXYZR& a, const ParticleXYZR& b)
    {
      pcl17::tracking::ParticleXYZR newp;
      newp.x = a.x + b.x;
      newp.y = a.y + b.y;
...
namespace pcl17
{
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYRPY : public _ParticleXYRPY
    {
      ...
      static pcl17::tracking::ParticleXYRPY
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl17::tracking::ParticleXYRPY (trans_x, 0, trans_z, trans_roll, trans_pitch, trans_yaw));
      }
    ...
    // a * k
    inline pcl17::tracking::ParticleXYRPY operator * (const ParticleXYRPY& p, double val)
    {
      pcl17::tracking::ParticleXYRPY newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl17::tracking::ParticleXYRPY operator + (const ParticleXYRPY& a, const ParticleXYRPY& b)
    {
      pcl17::tracking::ParticleXYRPY newp;
      newp.x = a.x + b.x;
      newp.y = 0;
...
namespace pcl17
{
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYRP : public _ParticleXYRP
    {
      ...
      static pcl17::tracking::ParticleXYRP
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl17::tracking::ParticleXYRP (trans_x, 0, trans_z, 0, trans_pitch, trans_yaw));
      }
    ...
    // a * k
    inline pcl17::tracking::ParticleXYRP operator * (const ParticleXYRP& p, double val)
    {
      pcl17::tracking::ParticleXYRP newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl17::tracking::ParticleXYRP operator + (const ParticleXYRP& a, const ParticleXYRP& b)
    {
      pcl17::tracking::ParticleXYRP newp;
      newp.x = a.x + b.x;
      newp.y = 0;
...
namespace pcl17
{
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYR : public _ParticleXYR
    {
      ...
      static pcl17::tracking::ParticleXYR
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl17::tracking::ParticleXYR (trans_x, 0, trans_z, 0, trans_pitch, 0));
      }
    ...
    // a * k
    inline pcl17::tracking::ParticleXYR operator * (const ParticleXYR& p, double val)
    {
      pcl17::tracking::ParticleXYR newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl17::tracking::ParticleXYR operator + (const ParticleXYR& a, const ParticleXYR& b)
    {
      pcl17::tracking::ParticleXYR newp;
      newp.x = a.x + b.x;
      newp.y = 0;
...
#define PCL17_STATE_POINT_TYPES \
  (pcl17::tracking::ParticleXYR) \
  (pcl17::tracking::ParticleXYZRPY) \
  (pcl17::tracking::ParticleXYZR) \
  (pcl17::tracking::ParticleXYRPY) \
  (pcl17::tracking::ParticleXYRP)
