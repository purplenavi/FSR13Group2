#ifndef PCL17_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_H_
#define PCL17_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_H_

#include <pcl17/tracking/kld_adaptive_particle_filter.h>

template <typename PointInT, typename StateT> bool
pcl17::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::initCompute ()
{
...
template <typename PointInT, typename StateT> bool
pcl17::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::insertIntoBins
...
pcl17::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::resample ()
{
  unsigned int k = 0;
  unsigned int n = 0;
...
#define PCL17_INSTANTIATE_KLDAdaptiveParticleFilterTracker(T,ST) template class PCL17_EXPORTS pcl17::tracking::KLDAdaptiveParticleFilterTracker<T,ST>;
