#ifndef PCL17_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_OMP_FILTER_H_
#define PCL17_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_OMP_FILTER_H_

#include <pcl17/tracking/kld_adaptive_particle_filter_omp.h>

template <typename PointInT, typename StateT> void
pcl17::tracking::KLDAdaptiveParticleFilterOMPTracker<PointInT, StateT>::weight ()
{
  if (!use_normal_)
  {
#ifdef _OPENMP
...
#define PCL17_INSTANTIATE_KLDAdaptiveParticleFilterOMPTracker(T,ST) template class PCL17_EXPORTS pcl17::tracking::KLDAdaptiveParticleFilterOMPTracker<T,ST>;
