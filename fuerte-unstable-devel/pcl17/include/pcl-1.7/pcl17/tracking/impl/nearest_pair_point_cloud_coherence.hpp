#ifndef PCL17_TRACKING_IMPL_NEAREST_PAIR_PCL17_POINT_CLOUD_COHERENCE_H_
#define PCL17_TRACKING_IMPL_NEAREST_PAIR_PCL17_POINT_CLOUD_COHERENCE_H_
...
namespace pcl17
{
  namespace tracking
  {
    ...
    NearestPairPointCloudCoherence<PointInT>::initCompute ()
    {
      ...
      // initialize tree
      if (!search_)
        search_.reset (new pcl17::search::KdTree<PointInT> (false));
...
#define PCL17_INSTANTIATE_NearestPairPointCloudCoherence(T) template class PCL17_EXPORTS pcl17::tracking::NearestPairPointCloudCoherence<T>;
