#ifndef PCL17_TRACKING_IMPL_PARTICLE_OMP_FILTER_H_
#define PCL17_TRACKING_IMPL_PARTICLE_OMP_FILTER_H_

#include <pcl17/tracking/particle_filter_omp.h>

template <typename PointInT, typename StateT> void
pcl17::tracking::ParticleFilterOMPTracker<PointInT, StateT>::weight ()
{
  if (!use_normal_)
  {
#ifdef _OPENMP
...
#define PCL17_INSTANTIATE_ParticleFilterOMPTracker(T,ST) template class PCL17_EXPORTS pcl17::tracking::ParticleFilterOMPTracker<T,ST>;
