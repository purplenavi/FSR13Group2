#ifndef PCL17_TRACKING_PARTICLE_FILTER_H_
#define PCL17_TRACKING_PARTICLE_FILTER_H_
  ...
  namespace tracking
  {
    ...
    class ParticleFilterTracker: public Tracker<PointInT, StateT>
    {
      ...
      protected:
        ...
        pcl17::PassThrough<PointInT> pass_x_;
        /** \brief Pass through filter to crop the pointclouds within the hypothesis bounding box. */
        pcl17::PassThrough<PointInT> pass_y_;
        /** \brief Pass through filter to crop the pointclouds within the hypothesis bounding box. */
        pcl17::PassThrough<PointInT> pass_z_;
        ...
        boost::shared_ptr<pcl17::octree::OctreePointCloudChangeDetector<PointInT> > change_detector_;
...
// #include <pcl17/tracking/impl/particle_filter.hpp>
#ifdef PCL17_NO_PRECOMPILE
#include <pcl17/tracking/impl/particle_filter.hpp>
#endif

#endif //PCL17_TRACKING_PARTICLE_FILTER_H_
