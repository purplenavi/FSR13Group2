#ifndef PCL17_TRACKING_NEAREST_PAIR_PCL17_POINT_CLOUD_COHERENCE_H_
#define PCL17_TRACKING_NEAREST_PAIR_PCL17_POINT_CLOUD_COHERENCE_H_
  ...
  namespace tracking
  {
    ...
    class NearestPairPointCloudCoherence: public PointCloudCoherence<PointInT>
    {
      public:
        ...
        typedef boost::shared_ptr<pcl17::search::Search<PointInT> > SearchPtr;
        typedef boost::shared_ptr<const pcl17::search::Search<PointInT> > SearchConstPtr;
...
// #include <pcl17/tracking/impl/nearest_pair_point_cloud_coherence.hpp>
