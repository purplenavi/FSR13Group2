...
pcl17::PolynomialCalculationsT<real>::PolynomialCalculationsT ()
{
}
...
template <typename real>
inline void 
  pcl17::PolynomialCalculationsT<real>::Parameters::setZeroValue (real new_zero_value)
{
...
template <typename real>
inline void
  pcl17::PolynomialCalculationsT<real>::solveLinearEquation (real a, real b, std::vector<real>& roots) const
{
...
template <typename real>
inline void
  pcl17::PolynomialCalculationsT<real>::solveQuadraticEquation (real a, real b, real c, std::vector<real>& roots) const
{
...
template<typename real>
inline void
  pcl17::PolynomialCalculationsT<real>::solveCubicEquation (real a, real b, real c, real d, std::vector<real>& roots) const
{
...
template<typename real>
inline void
  pcl17::PolynomialCalculationsT<real>::solveQuarticEquation (real a, real b, real c, real d, real e,
...
template<typename real>
inline pcl17::BivariatePolynomialT<real>
  pcl17::PolynomialCalculationsT<real>::bivariatePolynomialApproximation (
      std::vector<Eigen::Matrix<real, 3, 1> >& samplePoints, unsigned int polynomial_degree, bool& error) const
{
  pcl17::BivariatePolynomialT<real> ret;
...
inline bool
  pcl17::PolynomialCalculationsT<real>::bivariatePolynomialApproximation (
      ...
      pcl17::BivariatePolynomialT<real>& ret) const
{
