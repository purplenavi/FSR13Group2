"""autogenerated by genpy from pcl17/PolygonMesh.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/PointCloud2','pcl17/Vertices[]']
