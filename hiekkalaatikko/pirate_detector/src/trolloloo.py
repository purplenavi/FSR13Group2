...
class pirate_detector:
    ...
    def __init__(self):
        ...
        self.image_subscribe = rospy.Subscriber('/camera/rgb/image_mono', Image, self.icb)
        self.rgb_subscribe = rospy.Subscriber('/camera/rgb/image_color', Image, self.rgb_callback)
        self.point_cloud_subscribe = rospy.Subscriber('/camera/depth/image', Image, self.cb)
    ...
    def image_callback(self, data):
        ...
        if self.UPDATE_PIRATE_DATA:
            ...
            #self.img = cv_image
            cv.ShowImage(self.cv_window_name, lollollol)
